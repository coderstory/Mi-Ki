...
public class ThemePather implements IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    private static void drmManager() throws NoSuchFieldException {
        ...
        patchCodeTwo("miui.drm.DrmManager", "isLegal", Context.class, String.class, "miui.drm.DrmManager$RightObject", XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
        patchCodeTwo("miui.drm.DrmManager", "isLegal", Context.class, File.class, File.class, XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
        patchCodeTwo("miui.drm.DrmManager", "isLegal", Context.class, String.class, File.class, XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
        patchCodeTwo("miui.drm.DrmManager", "isPermanentRights", "miui.drm.DrmManager$RightObject", XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
        patchCodeTwo("miui.drm.DrmManager", "isPermanentRights", File.class, XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
        patchCodeTwo("miui.resourcebrowser.view.ResourceOperationHandler", "isPermanentRights", XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
        patchCodeTwo("miui.resourcebrowser.view.ResourceOperationHandler", "isAuthorizedResource", XC_MethodReplacement.returnConstant(Boolean.valueOf(true)));
